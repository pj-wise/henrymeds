...
const ClientsView: React.FC = () => {
  ...
  const handleNextPage = () => {
    setCurrentPage((prevPage) =>
      Math.min(prevPage + 1, Math.floor(availableSlots.length / slotsPerPage)),
    );
  };

  const paginatedSlots = availableSlots.slice(
      ...
      <div className="max-w-md mx-auto p-4 bg-white shadow-md rounded-lg">
          ...
          <div className="mb-4">
            ...
            <div className="flex justify-between mt-4">
              ...
              <IconButton
                ...
                disabled={
                  (currentPage + 1) * slotsPerPage >= availableSlots.length
                }
              >
                <ArrowForwardIcon />
              </IconButton>
        ...
        >
          <Alert
            ...
            sx={{ width: "100%" }}
          >
            Please confirm within 30 minutes, or your reservation may be
            released.
          </Alert>
        </Snackbar>
      </div>
